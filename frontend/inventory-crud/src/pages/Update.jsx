...
const Update = async() => {
    ...
    const updateInventory = async(e) => {
        ...
        setIsLoading(true)
        try {
            await axios.put(`${VITE_BACKEND_URL}/api/inventory/${id}`, product)
                    ...
                    <form onSubmit={updateInventory}>
                        <div className="space-y-2">
                            ...
                            <div>
                                ...
                                <input type = "number" value={product.image} onChange={(e) => setProduct({...product, image: e.target.value})}  className="w-full block border p-3 text-gray-600 rounded focus:outline-none focus:shadow-outline focus:border-blue-200 placeholder:-gray-400" placeholder="Enter Image URL"/>
                            </div>
